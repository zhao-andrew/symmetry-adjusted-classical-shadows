...
def tally_pauli_matches(ops_dict, map_dict, u, pauli_measurement):
    ...
    swap unitary (generated by u) + n-qubit Pauli measurement (pauli_string).
    Updates ops_dict in-place and returns a list of the observables which were
    measured by this circuit.
    ...
    measured_ops : list
        ...
        measurement circuit. They are organized as a tuple, where the first
        entry is the ordered Majorana tuple and the second is the sign of the
        operator.
